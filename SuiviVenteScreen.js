...
import styles from "./globalStyles"; // Make sure the path is correct
...
export default function SuiviVentesScreen()
{
  ...
  const controleCodes = async () =>
  {
    try
    {
      ...
      const produitSnapshot = await get(ref(db, `produitsvendus/${codeProduit}`));
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={editKey ? styles.primaryBtn : styles.primaryBtn}>
        <Text style={styles.btnText} onPress={handleEnregistrer}>
          {editKey ? "Modifier Vente" : "Ajouter Vente"}
        </Text>
      </View>

      {editKey && (
        <View style={styles.cancelBtn}>
          <Text style={styles.btnText} onPress={resetForm}>
      ...
      <FlatList
          ...
          <View style={styles.card}>
            ...
            <View style={styles.cardActions}>
              <View style={styles.editBtn}>
                <Text style={styles.btnText} onPress={() => chargerVente(item)}>
                  Modifier
                </Text>
              </View>
        ...
        ListEmptyComponent={
          <Text style={styles.subtitle}>Aucune vente enregistrée</Text>
        }
      />
    </View>
  );
